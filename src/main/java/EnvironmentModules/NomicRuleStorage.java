 ...
 */
@Singleton
public class NomicRuleStorage implements SharedStateStorage,
		Provider<StatefulKnowledgeSession> {

	private final Logger logger = Logger.getLogger(NomicRuleStorage.class);
	...
	@Inject
	public NomicRuleStorage(@Rules Map<Integer, String> ruleFiles) {
		super();
...
//		baseConf.setOption(ShareAlphaNodesOption.NO);
		...
		//sessionConf.setOption(KeepReferenceOption.NO);
